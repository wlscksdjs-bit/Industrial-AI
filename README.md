...
저장소는 학기별 총 3개의 핵심 전공심화 과목으로 구성되어 있습니다. 각 폴더별 상세 내역은 폴더 내 개별 `README.md` 문서에서 확인하실 수 있습니다.
...
* **주요 학습 키워드**: `Logistic Regression`, `Lasso/Ridge regularization`, `KNN`, `SVM (Support Vector Machine)`, `Decision Tree`, `Ensemble (Bagging/Boosting)`, `Random Forest`, `PCA (Principal Component Analysis)`, `Clustering (K-Means/DBSCAN)`, `Anomaly Detection`.
* **학습 성과**: 스마트팩토리 품질 예측, 광양제철소 전력 사용량 예측 텀프로젝트 진행 및 알고리즘별 성능 평가 분석.
...
* **주요 학습 키워드**: `Chassis Systems`, `ADAS (Advanced Driver Assistance Systems)`, `Vehicle Development Process`, `Functional Safety (ISO 26262)`, `AUTOSAR`, `AIVD`, `In-Vehicle Networks (CAN/LIN/Ethernet)`, `Connected Vehicle (V2X/V2N)`, `EV Powertrain (BMS/Regenerative Braking/LDC/OBC)`.
...
* **주요 학습 키워드**: `Industrial OPC-UA Standard`, `Convolutional Autoencoder (Anomaly Detection)`, `MIMII Sound Pipeline`, `Linear Programming (LP/IP)`, `Dynamic Programming (DP)`, `Genetic Algorithm (GA)`, `Discrete Event Simulation (SimPy)`, `Job Shop Scheduling (JSSP)`.
* **학습 성과**: 양방향 LSTM(BiLSTM) 및 설명 가능한 AI(XAI) 기술 기반의 반도체 공정 설비 상태 기반 정비(CBM) 기말 텀프로젝트 소스코드 및 논문초안/최종보고서 도출.
...
| :--- | :--- | :--- |
| **제조 데이터 분석과 최적화** | **CBM using BiLSTM & XAI** (설비 예지보전) | 💻 [CBM 분석 파이썬 소스코드](./2026_1_제조%20데이터%20분석과%20최적화/텀프로젝트/2026254019_진찬언/텀프로젝트.py)<br>📕 [최종 완성 보고서 (DOCX)](./2026_1_제조%20데이터%20분석과%20최적화/텀프로젝트/CBM_BiLSTM_XAI_최종완성본.docx)<br>📝 [학술 논문 초안 (DOCX)](./2026_1_제조%20데이터%20분석과%20최적화/텀프로젝트/CBM_BiLSTM_XAI_논문초안.docx)<br>📊 [최종 발표 자료 (PPTX)](./2026_1_제조%20데이터%20분석과%20최적화/텀프로젝트/2026254019_진찬언/CBM_BiLSTM_XAI_진찬언(2026254019).pptx) |
...
| **머신러닝** | **공업 도메인 품질 및 전력 예측** | 💻 [충북대 산업인공지능학과 텀프로젝트 코드](./2026_1_머신러닝/실습/해당%20없음/충북대학교%20산업인공지능학과%20텀프로젝트.py) |
