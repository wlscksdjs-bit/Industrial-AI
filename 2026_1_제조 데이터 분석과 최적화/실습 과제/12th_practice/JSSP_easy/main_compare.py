...
def main():
    ...
    drl_df, drl_ms, drl_time = run_maskable_ppo(
        JOB_DATA, MACHINES, total_timesteps=50000, verbose=True)
    all_results.append({
        'name': 'DRL (Maskable PPO 50k)', 'makespan': drl_ms,
    ...
    draw_learning_curve(training_results, save_path="10th_drl_learning_curve.png")
